// =========================================================
// كود لوحة تحكم الإدارة والتأمين بـ MongoDB Atlas و Socket.io
...
// ⚡ إعدادات التحميل التدريجي للطلبات (Infinite Scroll) - 20 طلب في كل مرة بدل تحميلهم كلهم مرة واحدة
...
// الهوية والتصميم الافتراضي الأصلي للمطعم
const DEFAULT_THEME = {
  primaryColor: "#8E2130",
  primaryHover: "#681521",
...
// دالة مساعدة عامة لجلب النصوص المترجمة
...
// دالة مساعدة لتشفير النصوص وحماية الجدول من الثغرات البرمجية (XSS Protection)
...
// الاستماع لحدث تبديل اللغة وإعادة رسم محتويات اللوحة فوراً
...
// 1. فحص الأمان وقاعدة البيانات قبل تحويل الصفحة
async function initAdminSessionCheck() {
  ...
  try {
    ...
    // أ) فحص هل المستخدم الحالي إداري مسجل
    ...
    // ب) فحص هل توجد حسابات سوبر أدمن سابقة بقاعدة البيانات
...
// 2. معالجة نموذج الإنشاء اليدوي لحساب المالك الأول
...
function listenToSocketEvents() {
  ...
  socket.on("new-order-global", (order) => {
    ...
    // ⚡ بدل ما نعيد تحميل كل الطلبات من الأول (وده كان بيلغي التمرير التدريجي)
    // بنحدث الأرقام بس وبنضيف الطلب الجديد فوق القائمة المعروضة
  ...
  socket.on("order-deleted-global", (payload) => {
    ...
    // ⚡ الطلب اتشال من القائمة المحلية فعلاً فوق، مش محتاجين نعيد تحميل كل الصفحات من الأول
    refreshAdminStatsOnly();
  });
}
...
// ================= نظام قسم "التصاميم" الفاخر (18 هوية معمارية متكاملة) =================
const DESIGN_THEME_TEMPLATES = {
  ottoman_royal: {
    name: "الملكي العثماني",
    theme: {
      primaryColor: "#831826",
      primaryHover: "#6b121e",
      ...
      borderRadius: "18px",
      fontFamily: "Tajawal",
      customCss: "/* الهوية العثمانية الفاخرة */",
    },
  },
  heritage_flame: {
    name: "جمر وتراث أصيل",
    theme: {
      ...
      borderRadius: "12px",
      fontFamily: "Cairo",
      customCss: "/* هوية الجمر والمشاوي التراثية */",
    },
  },
  nordic_luxury: {
    name: "الزمرد الإسكندنافي",
    theme: {
      primaryColor: "#0f4c3a",
      primaryHover: "#0a3629",
      ...
      borderRadius: "22px",
      fontFamily: "Almarai",
      customCss: "/* هوية الفخامة الفندقية المعاصرة */",
    },
  },
  midnight_gold: {
    name: "عقيق المساء الذهبي",
    theme: {
      primaryColor: "#e6b422",
      primaryHover: "#c79812",
      ...
      borderRadius: "14px",
      fontFamily: "Changa",
      customCss: "/* ثيم الدارك مود الملكي */",
    },
  },
  levantine_brass: {
    name: "النحاس الشامي",
  ...
  copper_steakhouse: {
    ...
    theme: {
      ...
      customCss: "/* طابع الستيك هاوس الأمريكي */",
    },
  },
  riviera_terracotta: {
    name: "تراكوتا الريفييرا",
    theme: {
      primaryColor: "#ba4c3c",
      primaryHover: "#9c3b2d",
      ...
      borderRadius: "20px",
      fontFamily: "Tajawal",
      customCss: "/* هوية الساحل الإيطالي والتراكوتا */",
    },
  },
  urban_bistro: {
    name: "المينيمال الحديث",
    theme: {
      primaryColor: "#e63946",
      primaryHover: "#c82333",
      ...
      borderRadius: "10px",
      fontFamily: "Alexandria",
      customCss: "/* طابع البسترو المودرن النظيف */",
    },
  },
  napoli_pizzeria: {
    name: "بيتزا نابولي الإيطالية",
    theme: {
      primaryColor: "#c1272d",
      primaryHover: "#9c1e23",
      ...
      borderRadius: "14px",
      fontFamily: "Cairo",
      customCss: "/* هوية البيتزيريا الإيطالية الأصيلة */",
    },
  },
  classic_burger_diner: {
    name: "داينر البرجر الأمريكي",
    theme: {
      primaryColor: "#d62828",
      primaryHover: "#b31f1f",
      ...
      borderRadius: "10px",
      fontFamily: "Alexandria",
      customCss: "/* طابع الداينر الأمريكي الكلاسيكي */",
    },
  },
  sakura_sushi: {
    name: "ساكورا اليابانية",
    theme: {
      primaryColor: "#af1e3c",
      primaryHover: "#8c1830",
      ...
      borderRadius: "6px",
      fontFamily: "Almarai",
      customCss: "/* هوية الساكورا اليابانية الهادئة */",
    },
  },
  ocean_depths_seafood: {
    ...
    theme: {
      ...
      borderRadius: "18px",
      fontFamily: "Tajawal",
      customCss: "/* هوية المأكولات البحرية العميقة */",
    },
  },
  specialty_coffee_house: {
    name: "أروقة القهوة المختصة",
    theme: {
      primaryColor: "#6f4518",
      primaryHover: "#573512",
      ...
      borderRadius: "16px",
      fontFamily: "Reem Kufi",
      customCss: "/* هوية القهوة المختصة الدافئة */",
    },
  },
  parisian_patisserie: {
    name: "الباتيسري الباريسي",
    theme: {
      primaryColor: "#c98a9c",
      primaryHover: "#b06e82",
      ...
      borderRadius: "24px",
      fontFamily: "Changa",
      customCss: "/* هوية الباتيسري الباريسي الأنيقة */",
    },
  },
  cairo_street_koshary: {
    ...
    theme: {
      ...
      borderRadius: "12px",
      fontFamily: "Cairo",
      customCss: "/* هوية الأكل الشعبي المصري الأصيل */",
    },
  },
  balady_ahwa: {
    name: "أهوة بلدي",
    theme: {
      ...
      borderRadius: "8px",
      fontFamily: "Reem Kufi",
      customCss: "/* هوية الأهوة الشعبية العريقة */",
    },
  },
  taco_fiesta_mexicano: {
    name: "فييستا التاكو المكسيكي",
    theme: {
      primaryColor: "#e8542a",
      primaryHover: "#c2431f",
      ...
      borderRadius: "14px",
      fontFamily: "Alexandria",
      customCss: "/* هوية الفييستا المكسيكية الصاخبة */",
    },
  },
  urban_vegan_green: {
    name: "الأورجانيك الأخضر",
    theme: {
      primaryColor: "#3f7d4f",
      primaryHover: "#2f5f3c",
      ...
      borderRadius: "20px",
      fontFamily: "Almarai",
      customCss: "/* هوية الأكل الصحي والعضوي */",
    },
  },
};
...
// فحص ذكي: هل الألوان الحالية مطابقة 100% لقالب معين، أم تم تخصيص لون فردي ديناميكياً؟
...
// تحديث شارات القوالب بالاعتماد على التطابق الحقيقي للألوان
...
// اعتماد وتطبيق قالب جاهز: يملأ جميع الحقول ويحفظ في الداتا بيز
async function applyDesignTemplate(key) {
  const tpl = DESIGN_THEME_TEMPLATES[key];
  if (!tpl) return;
  if (
    !confirm(
      `سيتم تطبيق هوية "${tpl.name}" فوراً على الموقع بالكامل. يمكنك لاحقاً تغيير أي لون فردي بحرية تامة دون قيود. هل تريد المتابعة؟`,
    )
  )
    return;
...
// زر إيقاف تفعيل القوالب واستعادة التصميم والهوية الافتراضية الأصلية
async function resetToDefaultTheme() {
  ...
  const confirmMsg = isEn
    ...
    : "هل تريد إيقاف تفعيل القوالب واستعادة التصميم والهوية الافتراضية الأصلية للموقع؟";
  ...
  const successMsg = isEn
    ...
    : "تم استعادة التصميم والهوية الأصلية للموقع بنجاح وإلغاء القوالب!";
  alert(successMsg);
}
  ...
  try {
    ...
    if (s.content) {
      if (document.getElementById("restaurantName"))
        document.getElementById("restaurantName").value =
          s.name || s.content.brandName || (isEn ? "Restaurant" : "المطعم");
      ...
      if (document.getElementById("contentFooterText"))
        document.getElementById("contentFooterText").value =
          ...
          (isEn
            ...
            : "جميع الحقوق محفوظة © 2026 المطعم - طعم أصيل");
    }
      ...
      if (s.isOpenNow) {
        ...
        statusHelper.innerHTML = isEn
          ? '<i class="fa-solid fa-circle-check me-1 text-success"></i> The kitchen is currently OPEN and accepting orders online. (Current Time: ' +
            localTimeStr +
            ")"
          : '<i class="fa-solid fa-circle-check me-1 text-success"></i> المطبخ مفتوح ويستقبل الطلبات حالياً أونلاين بنجاح. (التوقيت الحالي: ' +
            localTimeStr +
            ")";
      } else {
        statusHelper.className =
        ...
        statusHelper.innerHTML = isEn
          ? '<i class="fa-solid fa-circle-xmark me-1 text-danger"></i> The kitchen is currently CLOSED. (Current Time: ' +
            ...
            s.closingTime +
            "])."
          : '<i class="fa-solid fa-circle-xmark me-1 text-danger"></i> المطبخ مغلق حالياً بقرار الإدارة أو لكون التوقيت الحالي (' +
            localTimeStr +
            ") خارج النطاق المحدد [" +
            s.openingTime +
            " - " +
...
// تحديث الألوان في المعاينة الفورية والـ Mockup لحظياً عند تحريك أي Color Picker
function updateLivePreviewStyles() {
  ...
  // تحديث الـ Interactive Mockup في تبويب "التصاميم" في الوقت الفعلي
...
// حفظ التصميم بعد أي تعديل يدوي مع فك قفل القوالب لضمان ديناميكية الألوان بالكامل
async function saveFullSiteBuilderSettingsToDB() {
  ...
  const content = {
    ...
    topSellersSubtitle: document.getElementById("contentTopSellersSubtitle")
      ...
      : `تشكيلة الوجبات الذهبية التي حازت على إعجاب عملائنا في ${name}`,
    ...
    footerText: document.getElementById("contentFooterText")
      ...
      : `جميع الحقوق محفوظة © 2026 مطبخ ${name} - طعم أصيل`,
  };
...
// تحديث أرقام الإحصائيات فوق الصفحة بس (من غير ما يلمس قائمة الطلبات أو يعمل Scroll reset)
...
// إعادة الضبط من أول صفحة - بتتنادى عند فتح التاب أو تغيير الفلتر/البحث
...
// ⚡ تحميل صفحة واحدة بس من الطلبات (20 طلب) - ده اللي بيمنع تحميل الـ 632 طلب مرة واحدة
...
// إظهار/إخفاء رسالة "جاري تحميل المزيد..." تحت الكروت
  ...
  if (show) {
    if (!el) {
      ...
      el.innerHTML =
        ...
        '<i class="fa-solid fa-spinner fa-spin me-1"></i> جاري تحميل المزيد من الطلبات...';
...
// مراقب تمرير (IntersectionObserver): لما آخر كارت في القائمة يظهر في الشاشة
// بيطلب تلقائياً الصفحة الجاية (20 طلب تاني) - ده هو الـ Infinite Scroll
...
// إضافة طلب جديد جاي لايف من Socket.io فوق القائمة من غير ما نعمل Reset لكل الصفحات المحملة
function prependNewOrderToList(order) {
  if (!order || !order._id) return;
  if (allOrdersList.some((o) => String(o._id) === String(order._id))) return;

  // لو فيه فلتر أو بحث شغال والطلب الجديد مش هيظهر فيه، منضيفوش للقائمة المعروضة
...
// ⚡ الفلترة بقت بتتنفذ في السيرفر (مش بس على الـ 20 طلب المحملين)، وبتبدأ ترقيم صفحات جديد
function filterAdminOrders(status) {
  ordersActiveFilter = status;
  resetAndLoadOrders();
}

// ⚡ البحث بقى بيتنفذ في السيرفر على كل الطلبات، مع Debounce بسيط عشان ميبعتش طلب مع كل حرف
...
function populateCategorySelectDropdown() {
  ...
  if (allCategoriesList.length === 0) {
    select.innerHTML = `<option value="عام">${t("all")}</option>`;
    return;
  }
...
// ================= 7. سجل الأمان والرقابة (Audit Logs) =================
...
// =========================================================
// دوال رفع ومعاينة صور الأطباق والوجبات (رفع من الجهاز + رابط)
// =========================================================
...
// تصدير الدوال للنافذة العامة (Window Exports)
